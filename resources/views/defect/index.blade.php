...
<div class="content defect">
    <div class="defect-btn">
        <a href="creatcard.html" class="defect__button"><span class="defect-icon-btn"></span>Создать ведомость</a>
    </div>
    <div class="defect-table scroll-table">
        <table>
            ...
            <tr class="table-column">
                ...
                <th class="table-col" tabindex="0">
                    <div class="table-col__inner table-col__sort">Пробег</div>
                    <input type="text" class="table-col__input" placeholder="Поиск...">
                </th>
                <th class="table-col" tabindex="0">
                    <div class="table-col__inner table-col__sort">Создал</div>
                    <input type="text" class="table-col__input" placeholder="Поиск...">
                </th>
        ...
        <div class="scroll-table-body">
            <table>
                ...
                <tr class="table-row__list" data-index="0">
                    ...
                    <td class="table-row__item">00000 км</td>
...
@section('title', 'Дефектовочная ведомость')
